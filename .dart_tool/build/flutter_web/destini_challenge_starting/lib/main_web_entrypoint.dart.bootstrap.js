...
define("main_web_entrypoint.dart.bootstrap", ["packages/destini_challenge_starting/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:destini_challenge_starting/main_web_entrypoint.dart") {
          // Clear static caches.
