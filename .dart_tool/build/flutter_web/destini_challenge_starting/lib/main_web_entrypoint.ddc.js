define(['dart_sdk', 'packages/destini_challenge_starting/main'], function(dart_sdk, packages__destini_challenge_starting__main) {
  'use strict';
  ...
  const main = packages__destini_challenge_starting__main.main;
  ...
  dart.trackLibraries("packages/destini_challenge_starting/main_web_entrypoint", {
    "package:destini_challenge_starting/main_web_entrypoint.dart": main_web_entrypoint
  }, {
